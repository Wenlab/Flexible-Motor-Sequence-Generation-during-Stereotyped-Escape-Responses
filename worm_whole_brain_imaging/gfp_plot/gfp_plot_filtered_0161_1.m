...
for i=1:ImgLength
    if N1(i)<N1_min*1.055 || N2(i)<N2_min*1.19
        N1_filtered(i)=NaN;
        N2_filtered(i)=NaN;
    else
        N1_filtered(i)=N1(i);
...
%%  
for i=1:ImgLength-487
    N1_filtered_normalized_shifted(i)=N1_filtered_normalized(i+487);
    N2_filtered_normalized_shifted(i)=N2_filtered_normalized(i+487);
end
plot(N2_filtered_normalized_shifted);%N1 or N2?

%%
ax=gca;
xticks=linspace(0,1200,13);
ax.XTick=xticks;
